...
<?php include(ROOT_PATH . "/app/controllers/ideas.php");
adminOnly();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Admin - Create Idea Post</title>
</head>
...
<body>
    ...
    <div class="admin-wrapper clearfix">
        ...
        <div class="admin-content clearfix">
            ...
            <div class="">
                <h2 style="text-align: center;">Create IDEA</h2>
                ...
                <form action="create.php" method="post" enctype="multipart/form-data">
                    ...
                    <!-- Checkbox for publishing -->
                    <div class="input-group">
                        <button type="submit" name="add-idea" class="btn">Post Idea</button>
                    </div>
                </form>
